...
def trade_alert(symbol, direction, entry, sl, tp1, tp2, score, entry_reasons=None):
    emoji        = "🟢" if direction == "LONG" else "🔴"
    reasons_list = entry_reasons or []
    reasons_text = '\n'.join([f"  • {r}" for r in reasons_list[:6]])
    msg = f"""
